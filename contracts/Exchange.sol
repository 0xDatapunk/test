...
contract Exchange is IExchange, ReentrancyGuarded, EIP712, OwnableUpgradeable, UUPSUpgradeable {
        ...
        */
        ...
        for (uint8 i = 0; i < executionsLength; i++) {
            ...
            assembly {
                ...
                result := delegatecall(gas(), address(), memPointer, add(size, 0x04), 0, 0)
            }
            console.log("#%d tx with result start ETH ", i, result, startETH);
            console.log("#%d tx with result remaining ETH ", i, result, remainingETH);
        }
    ...
    function _validateUserAuthorization(
        ...
        if (signatureVersion == SignatureVersion.Single) {
            ...
            // @audit merklePath.length is not checked
